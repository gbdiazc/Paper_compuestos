...
plt.plot(comp,sols_fnew,'<',color=colors[3],label="Fortran new")
#
...
plt.legend(loc='upper center', bbox_to_anchor=(0.5, 1.17),#bbox_to_anchor=(0.3, 0.23),
          fancybox=True, shadow=True, ncol=4, fontsize=fs-8)
#plt.ylim(300,550)
plt.grid(axis='y')
#plt.title(sheet_n, fontsize=fs+2)
plt.tight_layout()
...
plt.plot(comp,Crit_val["Pc"][:,3],'<',color=colors[3],markersize =8,label="Fortran new")

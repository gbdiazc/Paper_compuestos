...
runs   = [7000,10000,20000, 30000,40000,50000,70000,100000,200000,500000]  
#runs   = [7000,10000,20000, 30000]
#runs    = [10000] 
...
for component in components:
    ...
    OF_all_s = np.zeros((l_runs,runs_rank,500))
    ...
    for case in cases:
        ...
        for run_s in range(runs_rank):
            ...
            for run_its in runs:
                ...
                v = feasible[min_OF]
                TBv    = TB_f(v,IFG)
                OF_all_s[run_c,run_s,0:fi]    = X_obj_f
                if TBE_exp== False:
                    TBE = TBS_MG(v,IFG)
